/// Self-contained highlights adjustment.
///
/// `value = 0.0` is neutral.
/// Positive values lift bright regions, negative values reduce bright regions.
...
impl Default for HighlightsAdjustment {
    fn default() -> Self {
        Self { value: 0.0 }
    }
}

impl HighlightsAdjustment {
    ...
    pub fn apply(&self, pixels: &mut [u8]) {
        ...
        for chunk in pixels.chunks_exact_mut(4) {
            ...
            let weight = Self::smoothstep(0.5, 1.0, luma);
